...
--
-- Host: 127.0.0.1
-- Tempo de geração: 28-Abr-2023 às 05:08
...
CREATE TABLE `clientes` (
  ...
  `estado` enum('AC','AL','AP','AM','BA','CE','DF','MA','MT','MS','MG','PA','PB','PR','PE','PI','RJ','RN','RS','RO','RR','SC','SE','TO','SP','ES') NOT NULL
...
('Yasmin Pereira Lima Oliveira', 'Av. Águia de Haia, 2633', 'Cidade Antônio Estêvão de Carvalho', 3694000, 'São Paulo', 'SP'),
...
('Fernanda Ferraz\r\nSilva', 'Rua Fernão Dias 551', 'Pinheiros', 54270000, 'São Paulo', 'SP'),
('Raquel Santos Lima', 'Rua Almirante Barroso, 7654', 'Vila Nova', 89216220, 'Blumenau', 'SC'),
('Fernando Ramos da Silva', 'Av. Carlos Gomes, 700', 'Jatiuca', 90480760, 'Maceió', 'AL'),
...
('Bryan Barros Medeiros', 'Av. Dante Michelini, 4355', 'Jardim Camburi', 29090070, 'Vitória', 'ES');
COMMIT;
